...
// Màu chấm góc 
  ...
  }, [imageURL, dotType, dotColor, bgColor, cornerSquareType, cornerDotType, bgSquareType, bgDotType, logo]);
  ...
  const handleImageUpload = async (event) => {
    ...
    formData.append('upload_preset', 'ml_oscar'); // Sử dụng upload preset của bạn

    const response = await fetch('https://api.cloudinary.com/v1_1/dazno8bg3/image/upload', {
      method: 'POST',
      body: formData,
    });

    const data = await response.json();
    setImageURL(data.secure_url); // URL của hình ảnh sau khi tải lên
  };
          ...
          <div className="section">
            <div className="title-home-section">
              <h3 className='title-home-section-children'>
                <span>2. Thêm nội dung vào mã QR Hình ảnh</span>
              </h3>
            </div>
            <div className="card-section">
              <section className='card-section_container'>
                ...
                <div className="card-section-url_title">
                  <div className="card-section-url_title-text">
                    <p className="mui-styled-title">Mã QR cho hình ảnh </p>
                    <span className='mui-styled-title_children'>Nhập hình ảnh mà bạn muốn liên kết tới</span>
                    <div className='mui-styled-content_handleInput'>
                      <div className="mui-styled-content_handleInput_Page"> 
                        <hr />
                        <p className="mui-styled-title_URL">Hình ảnh*</p>
                        <input 
