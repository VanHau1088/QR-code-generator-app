          ...
          <div className="section">
            <div className="title-home-section">
              <h3 className='title-home-section-children'>
                <span>2. {t("addContentToQrWiFi")}</span>
              </h3>
            </div>
            <div className="card-section">
              <section className='card-section_container'>
                ...
                <div className="card-section-url_title">
                  <div className="card-section-url_title-text">
                    <p className="mui-styled-title">{t("WiFiQRCode")}</p>
                    <span className='mui-styled-title_children'>{t("Creating a QR code is easy and customizable for WiFi in minutes.")}</span>
                    <div className='mui-styled-content_handleInput'>
                  {/* Tên wifi (SSID) */}
                      <div className="mui-styled-content_handleInput_Page"> 
                          <hr />
                          <p className="mui-styled-title_URL">{t("TitleWifi")}</p>
                          <input 
                      ...
                      {/* Mã hóa  */}
                      <div className="mui-styled-content_handleInput_Page"> 
                          <p className="mui-styled-title_URL">{t("Encode")}</p>
                            <select  className='mui-styled-content_handleInput_Page-URL'  value={networkType} 
                    ...
                    {/* Mật khẩu */}
                    <div className="mui-styled-content_handleInput_Page"> 
                          <p className="mui-styled-title_URL">{t("Password")}</p>
                          <input 
                            className='mui-styled-content_handleInput_Page-URL' 
                            aria-invalid='false' 
                            type="password" 
                            placeholder="110789Bumbo" 
                            value={password}
                      ...
                      <div className="template-preview-content-wrapper">
                        ...
                        {ssid && networkType && password && (
                          ...
                          <div className="downloadQRCode">
                            ...
                            <button onClick={handleUpdateWifi} className='hidden'>Cập nhật Văn bản</button>
                          </div>
                        )}
                      </div>
                    </div>
