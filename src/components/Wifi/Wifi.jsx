          ...
          <div className="section">
            <div className="title-home-section">
              <h3 className='title-home-section-children'>
                <span>2. Thêm nội dung vào mã QR WiFi</span>
              </h3>
            </div>
            <div className="card-section">
              <section className='card-section_container'>
                ...
                <div className="card-section-url_title">
                  <div className="card-section-url_title-text">
                    <p className="mui-styled-title">Mã QR WIFI</p>
                    <span className='mui-styled-title_children'>Tạo mã QR dễ dàng và có thể tùy chỉnh WiFi trong vài phút.</span>
                    <div className='mui-styled-content_handleInput'>
                  {/* Tên wifi (SSID) */}
                      <div className="mui-styled-content_handleInput_Page"> 
                          <hr />
                          <p className="mui-styled-title_URL">Tên wifi (SSID)*</p>
                          <input 
                      ...
                      {/* Mã hóa  */}
                      <div className="mui-styled-content_handleInput_Page"> 
                          <p className="mui-styled-title_URL">Mã hóa*</p>
                    ...
                    {/* Mật khẩu */}
                    <div className="mui-styled-content_handleInput_Page"> 
                          <p className="mui-styled-title_URL">Mật khẩu</p>
                          <input 
                            className='mui-styled-content_handleInput_Page-URL' 
                            aria-invalid='false' 
                            type="password" 
