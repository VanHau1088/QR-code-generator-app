                ...
                <div className="card-section">
                  <ul className="card-section-content">
                    ...
                    <NavLink to= 'URL'> 
                        <button className='template-selector__item-container' to = 'URL'  onMouseEnter={() =>
                                      setImageSrc(
                                            '/src/assets/Image/ImageHover/url.jpg'
                                      )
                                    }
                          >
                            <div className="template-selector__item-container-logo">
                              <img src="/src/assets/Image/Icons/url.png" alt="" />
                            </div>
                    ...
                    <NavLink to= 'Card'> 
                        ...
                        onMouseEnter={() =>
                          setImageSrc(
                            '/src/assets/Image/ImageHover/vcard.jpg'
                          )
                        }>
                            <div className="template-selector__item-container-logo">
                            <img src="/src/assets/Image/Icons/card.png" alt="" />
                            </div>
                  ...
                  {/* Email */}
                    ...
                    <NavLink to= 'Email'> 
                        ...
                        >
                            <div className="template-selector__item-container-logo">
                            <img src="/src/assets/Image/Icons/image.png" alt="" />
                            </div>
                    ...
                    <NavLink to= 'Video'> 
                        <button className='template-selector__item-container' to = 'Video'
                            onMouseEnter={() =>
                              setImageSrc(
                                '/src/assets/Image/ImageHover/video.jpg'
                              )
                            }
                        >
                            <div className="template-selector__item-container-logo">
                            <img src="/src/assets/Image/Icons/video-camera.png" alt="" />
                            </div>
                  ...
                  {/* Văn bản đơn giản */}
                    ...
                    <NavLink to= 'Text'> 
                        <button className='template-selector__item-container' to = 'Text'
                              onMouseEnter={() =>
                                setImageSrc(
                                  '/src/assets/Image/ImageHover/text.jpg'
                                )
                              }
                        >
                            <div className="template-selector__item-container-logo">
                            <img src="/src/assets/Image/Icons/font.png" alt="" />
                            </div>
                  ...
                  {/* SMS */}
                   <li className="card-section-content-SMS">
                    <NavLink to= 'SMS'> 
                        ...
                        >
                            <div className="template-selector__item-container-logo">
                                <img src="/src/assets/Image/Icons/menu.png" alt="" />
                            </div>
                  ...
                  {/* Sự kiện */} 
                    ...
                    <NavLink to= 'Event'> 
                        <button className='template-selector__item-container' to = 'Event'
                           onMouseEnter={() =>
                            setImageSrc(
                              '/src/assets/Image/ImageHover/business.jpg'
                            )
                          }
                        >
                            <div className="template-selector__item-container-logo">
                            <img src="/src/assets/Image/Icons/my-business.png" alt="" />
                            </div>
                   ...
                   {/* PDF */}
                    ...
                    <NavLink to= 'PDF'> 
                        <button className='template-selector__item-container' to = 'PDF'
                         onMouseEnter={() =>
                          setImageSrc(
                            '/src/assets/Image/ImageHover/pdf.jpg'
                          )
                        }
                        >
                            <div className="template-selector__item-container-logo">
                            <img src="/src/assets/Image/Icons/file.png" alt="" />
                            </div>
                    ...
                    <NavLink to= 'Social_media'> 
                        <button className='template-selector__item-container' to = 'Social_media'
                            onMouseEnter={() =>
                              setImageSrc(
                                '/src/assets/Image/ImageHover/social.jpg'
                              )
                            }
                        >
                            <div className="template-selector__item-container-logo">
                            <img src="/src/assets/Image/Icons/social-media.png" alt="" />
                            </div>
                   ...
                   {/* <li className="card-section-content-Facebook">
                    <NavLink to= 'Facebook'> 
                        <button className='template-selector__item-container' to = 'Facebook'
                             onMouseEnter={() =>
                              setImageSrc(
                                '/src/assets/Image/ImageHover/fb.jpg'
                              )
                            }
                        >
                            <div className="template-selector__item-container-logo">
                            <img src="/src/assets/Image/Icons/facebook.png" alt="" />
                            </div>
                  ...
                  {/* <li className="card-section-content-Business">
                    ...
                    <NavLink to= 'apps'> 
                        <button className='template-selector__item-container' to = 'apps'
                           onMouseEnter={() =>
                            setImageSrc(
                              '/src/assets/Image/ImageHover/application.jpg'
                            )
                          }
                        >
                            <div className="template-selector__item-container-logo">
                                <img src="/src/assets/Image/Icons/smartphone.png" alt="" />
                            </div>
