...
// Màu chấm góc 
  ...
  }, [pdfContent, dotType, dotColor, bgColor, cornerSquareType, cornerDotType, bgSquareType, bgDotType, logo]);
  ...
  // Load PDF 
  const handleUploadPdfClick = async (event) => { 
    ...
    if (file) { 
      ...
      reader.onload = async (e) => { 
        ...
        setPdfContent(textContent.join(' ')); // Chuyển đổi nội dung PDF thành chuỗi văn bản }; reader.readAsArrayBuffer(file); } };
      }
    };
  }
  return (
        ...
        <div className="section">
          <div className="title-home-section">
            <h3 className='title-home-section-children'>
              <span>2. Thêm nội dung vào mã QR PDF</span>
            </h3>
          </div>
          <div className="card-section">
            <section className='card-section_container'>
              ...
              <div className="card-section-url_title">
                <div className="card-section-url_title-text">
                  <p className="mui-styled-title">Tập tin PDF*</p>
                  <span className='mui-styled-title_children'>Tải lên tập tin PDF của bạn</span>
