        ...
        <div className="content">
          <div className="section">
            <div className="title-home-section">
              ...
              <span>2. {t("addContentToQrMap")}</span>
              </h3>
            </div>
            <div className="card-section">
              <section className='card-section_container'>
                ...
                <div className="card-section-url_title">
                  <div className="card-section-url_title-text">
                    <p className="mui-styled-title">{t("Location")}</p>
                    <span className='mui-styled-title_children'>{t("Creating a QR code is easy and customizable for Map in minutes.")}</span>
                    <div className='mui-styled-content_handleInput'>
                   
                    {/*  Vĩ độ  */}
                  <div className="mui-styled-content_handleInput_Page"> 
                        <p className="mui-styled-title_URL">{t("Latitude")}</p>
                        <input 
                     ...
                     {/* Kinh độ */}
                      <div className="mui-styled-content_handleInput_Page"> 
                        <hr />
                        <p className="mui-styled-title_URL">{t("Longitude")}</p>
                        <input 
                          className='mui-styled-content_handleInput_Page-URL' 
                          aria-invalid='false' 
                          type="number" 
